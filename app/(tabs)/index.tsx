            ...
            <View style={styles.projectList}>
              {projects.slice(0, 5).map((project) => (
                <View key={project.id} style={styles.projectRow}>
                  ...
                  <Text style={styles.projectMeta}>{new Date(project.createdAt).toLocaleDateString()}</Text>
                </View>
              ))}
            </View>
          )}
...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#8b8b9e', fontSize: 14, marginTop: 8 },
  ...
  videoCard: { width: 160, marginRight: 12, backgroundColor: '#252542', borderRadius: 16, overflow: 'hidden' },
  thumbnail: { width: '100%', height: 200, backgroundColor: '#1a1a2e', justifyContent: 'center', alignItems: 'center' },
  ...
  videoTitle: { color: '#fff', fontSize: 13, fontWeight: '600', marginBottom: 4 },
  videoMeta: { color: '#8b8b9e', fontSize: 11 },
  emptyState: { marginHorizontal: 20, backgroundColor: '#252542', borderRadius: 16, padding: 40, alignItems: 'center' },
  emptyIcon: { fontSize: 48, marginBottom: 12 },
  emptyText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  emptySubtext: { color: '#8b8b9e', fontSize: 13, marginTop: 4 },
  projectList: { marginHorizontal: 20, backgroundColor: '#252542', borderRadius: 16, padding: 16, gap: 12 },
  projectRow: { borderBottomWidth: 1, borderBottomColor: '#1a1a2e', paddingBottom: 10 },
  projectTitle: { color: '#fff', fontSize: 14, fontWeight: '600' },
  projectMeta: { color: '#8b8b9e', fontSize: 11, marginTop: 4 },
});
